...
<div class="row-fluid">
    ...
    <div class="alert alert-info">
        ...
        <strong>Running Build info goes here </strong>
    </div>
...
<div class="row-fluid">
    <div class="block span6">
        <a href="#tablewidget" class="block-heading" data-toggle="collapse">Branches<span id="branchcount" class="label label-warning">+10</span></a>
        <div id="tablewidget" class="block-body collapse in">
            <table id="buildproc" class="table">
            	<thead>
                <tr>
                  <th>Action</th>
                  <th>Branch</th>
    ...
    <div class="block span6">
    	<div class="block-heading"><span class="block-icon pull-right">
                <a href="#" class="demo-cancel-click" rel="tooltip" title="Click" onclick="AjaxCall();" ><i class="icon-refresh"></i></a>
            </span>
                <a href="#widget1container" class="block-heading" data-toggle="collapse">Collapsible </a>
        </div>
        <div id="widget1container" class="block-body collapse in">
            <textarea rows="15" cols="" id="responsediv" name="responsediv" style="width: 478px;"></textarea>
        </div>
    </div>
</div>
