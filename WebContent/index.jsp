  ...
  <!--<![endif]-->
    ...
    <div class="navbar">
        <div class="navbar-inner">
                <ul class="nav pull-right">
                    ...
                    <li id="fat-menu" class="dropdown">
                        <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown">
                            <i class="icon-user"></i> <%=userBean.getFirstname() %>
                ...
                <a class="brand" href="index.html"><span class="first">CCC</span> <span class="second">Config.</span></a>
        </div>
    </div>
    ...
    <div class="sidebar-nav">
        ...
        <ul id="accounts-menu" class="nav nav-list collapse">
            ...
            <li ><a href="reset-password.html" target="dshcenter">Reset Password</a></li>
        </ul>
        ...
        <ul id="legal-menu" class="nav nav-list collapse">
            <li ><a href="privacy-policy.html" target="dshcenter">Privacy Policy</a></li>
            <li ><a href="terms-and-conditions.html" target="dshcenter">Terms and Conditions</a></li>
        </ul>

        <a href="help.html  target="dshcenter" class="nav-header" ><i class="icon-question-sign"></i>Help</a>
        <a href="faq.html" class="nav-header"  target="dshcenter"><i class="icon-comment"></i>Faq</a>
    </div>
    

   <iframe src="/servlet/dashboard.jsp" name="dshcenter" 
    style="border-left-width: 1px; width: 1107px; margin-right: 10px; border-right-width: 1px; margin-left: 240px; position: absolute; height: 632px;" src="/servlet/user.html"></iframe> 
